...
class Session:
    ...
    def inf_batch(self, name, batch):
        ...
        O, O_2, O_4, O_guide, B = batch['O'].cuda(), batch['O_2'].cuda(), batch['O_4'].cuda(), batch['guide'].cuda(), \
                                  batch['B'].cuda()
        O, O_2, O_4, O_guide, B = Variable(O, requires_grad=False), Variable(O_2, requires_grad=False), Variable(O_4,
                                                                                                                 requires_grad=False), Variable(
            O_guide, requires_grad=False), Variable(B, requires_grad=False)
        derain = self.net(O, O_2, O_4, O_guide)
    ...
    def inf_batch_test(self, name, batch):
        ...
        O, O_2, O_4, O_guide, B = batch['O'].cuda(), batch['O_2'].cuda(), batch['O_4'].cuda(), batch['guide'].cuda(), \
                                  batch['B'].cuda()
        O, O_2, O_4, O_guide, B = Variable(O, requires_grad=False), Variable(O_2, requires_grad=False), \
                                  Variable(O_4, requires_grad=False), Variable(O_guide, requires_grad=False), Variable(
