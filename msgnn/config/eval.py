...
class Session:
    ...
    def inf_batch(self, name, batch):
        O, O_2, O_4, O_guide, B = batch['O'], batch['O_2'], batch['O_4'], batch['guide'], batch['B']
        O, O_2, O_4, O_guide, B = Variable(O, requires_grad=False).cuda(), Variable(O_2, requires_grad=False).cuda(), \
                                  Variable(O_4, requires_grad=False).cuda(), Variable(O_guide, requires_grad=False).cuda(), Variable(
            B, requires_grad=False).cuda()
